...
│   │   └── java/
│   │       ├── base/
│   │       │   └── BasePage.java              # Base class for WebDriver setup
│   │       │
│   │       ├── listeners/
│   │       │   └── ExecutionOrderReporter.java # Custom TestNG reporter to show execution order
│   │       │
│   │       └── page/
│   │           ├── Cart.java
│   │           ├── Checkout.java
...
│   │           └── SingupLogin.java
│   │
│   └── resources/                    # (optional) Config or test data files
│
├── src/
│   └── test/
│       └── java/
│           └── test/
│               └── EndToEndTesting.java        # Main TestNG test class (end-to-end flow)
│
├── test-output/                      # Generated reports after execution
│   ├── emailable-report.html         # Default TestNG report
│   ├── index.html                    # TestNG dashboard summary
│   └── execution-order.txt           # (Generated by ExecutionOrderReporter)
│
